#!/usr/bin/env python3
"""Deploy contracts/evidence_receipt.py to GenLayer StudioNet and record the
...
- refuses to deploy unless contracts/evidence_receipt.py is committed and
...
CONTRACT_PATH = "contracts/evidence_receipt.py"
        ...
        try:
            request = urllib.request.Request(
                RPC, data=body, headers={"Content-Type": "application/json",
                                         "User-Agent": "evidence-receipt-deploy"})
