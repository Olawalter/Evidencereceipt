"""Direct Mode harness for contracts/evidence_receipt.py (see support.py for
...
def _tolerate_windows_unlink():
    ...
    if getattr(original, "_evidence_receipt_shim", False):
        return
    ...
    inject_tolerant._evidence_receipt_shim = True
